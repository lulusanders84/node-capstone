...
function registerNewUser() {
	...
	$.ajax({
		method: "POST",
		url: 'https://shielded-beach-86793.herokuapp.com/api/users',
...
function sendLoginPostRequest(username, password) {
	...
	$.ajax({
		method: "POST",
		url: 'https://shielded-beach-86793.herokuapp.com/api/auth/login',
...
function getAndDisplayUnitList() {
	$.ajax({
		type: "GET",
		url: "https://shielded-beach-86793.herokuapp.com/api/patients",
		headers: {
			"Access-Control-Allow-Origin": "*"
		}
	}).done(function(data) {
...
function addPatientsToUsersAssignmentList() {
	...
	user.done(function(data) {
			...
			$.ajax({
				method: "PUT",
				url: `https://shielded-beach-86793.herokuapp.com/api/users/${userId}`,
...
function getAndDisplayAssignmentList() {
	...
	$.ajax({
		type: "GET",
		url: `https://shielded-beach-86793.herokuapp.com/api/users/assignment/${userId}`,
		headers: {
			"Access-Control-Allow-Origin": "*",
			"Authorization": `Bearer ${getAuthToken()}`
		}
...
function getAndDisplayPatientReport(patientId) {
	$.ajax({
		type: "GET",
		url: `https://shielded-beach-86793.herokuapp.com/api/reports/${patientId}`,
		headers: {
			"Access-Control-Allow-Origin": "*",
			"Authorization": `Bearer ${getAuthToken()}`
		}
...
function handleSliderChange() {
	$('.js-slider').change(function() {
		...
		$.ajax({
			method: "PUT",
			url: `https://shielded-beach-86793.herokuapp.com/api/reports/`,
